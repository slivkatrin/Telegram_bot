...
filterTgtg = ["Auchan Gdynia Górskiego", "Minuta Osiem Gdynia", "Minuta Osiem Express", "Cukiernia Kaiser Patisserie", "Głodny Niedźwiedź", "Smart Bistro ","Smart Bistro", "Deserownia - Legionów", "Ogniem i Piecem"]
...
def parse_tgtg_api(api_result):
    ...
    for store in api_result:
        ...
        #if current_item['store_name'] not in filterTgtg:
        #    continue
